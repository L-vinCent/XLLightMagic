...
@objc protocol LTPageViewHeaders: NSObjectProtocol {
    ...
    //MARK: 构造方法
    @objc init(frame: CGRect, currentViewController: UIViewController, viewControllers:[UIViewController], titles: [String], layout: XPageLayout, itemViewClass: XPageTitleItem.Type?)
...
public class LTPageView: UIView, LTPageViewHeaders {
    ...
    @objc public func customLayoutItems(handle: (([XPageTitleItem], LTPageView) -> Void)?) {
    ...
    private lazy var scrollView: LTPageScrollView = {
        let scrollView = LTPageScrollView(frame: CGRect(x: 0, y: 0, width: width, height: height))
    ...
    @objc convenience public init(frame: CGRect, currentViewController: UIViewController, viewControllers:[UIViewController], titles: [String], layout: XPageLayout) {
    ...
    @objc required public init(frame: CGRect, currentViewController: UIViewController, viewControllers:[UIViewController], titles: [String], layout: XPageLayout, itemViewClass: XPageTitleItem.Type? = nil) {
...
//        self.delegate = titleView
    ...
    final func makeupPageView(_ pageView:LTPageView, _ titleView: XPageTitleView) {
        //设置滑动view的代理为LTPageTitleView
...
extension LTPageView {
    ...
    final func glt_createViewController(_ index: Int)  {
        ...
        //修正外部scrollView的高
        glt_scrollView.height = glt_scrollView.height - Y
    }
